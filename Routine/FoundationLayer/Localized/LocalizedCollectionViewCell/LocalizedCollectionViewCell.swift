...
protocol LocalizedCollnctiobViewCellDelegate: class {
    func didSelectCellViewModel(viewModel: LocalizedCollectionViewCellViewModel)
}

class LocalizedCollectionViewCell<T: LocalizedCollectionViewCellViewModel>: UICollectionViewCell, LocalizedContainer, LocalizedConfigure {
