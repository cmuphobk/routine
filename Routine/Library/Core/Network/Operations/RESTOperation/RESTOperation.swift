...
final class RESTOperation<T: Decodable> : AsyncOperation, OperationHandlerContainerInterface {
    ...
    override func main() {
        ...
        let request = self.alamofireManager.request(url, method: requestObject.method, parameters: parameters, encoding: requestObject.encoding ?? URLEncoding.default, headers: requestObject.headers) as DataRequest
