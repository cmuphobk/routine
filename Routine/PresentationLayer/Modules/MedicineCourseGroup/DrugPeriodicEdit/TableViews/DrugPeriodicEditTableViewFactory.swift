...
final class DrugPeriodicEditTableViewFactory {
    ...
    static func makeDays(withValue: Int) -> [LocalizedTableViewCellViewModel] {
    ...
    static func makeDay(text: String, isSelected: Bool) -> LocalizedTableViewCellViewModel {
    ...
    static func makeCountDays(withValue: Int) -> [LocalizedTableViewCellViewModel] {
