...
final class StandartPagePickerCollectionViewFactory {
    ...
    static func standartPagePickerCellViewModels(models: [String], size: CGSize, font: UIFont, textColor: UIColor, backgroundColor: UIColor) -> [LocalizedCollectionViewCellViewModel] {
